...
import { Globe } from "../components/GlobeTemp";
    ...
    <section className="c-space section-spacing" id="about">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="grid-default-color grid-5 relative">
          <div className="z-10 w-[50%]">
            <p className="headtext text-white">Development Arsenal</p>
            <p className="subtext text-white">
              I work with a diverse range of programming languages, frameworks,
              and tools, enabling me to create efficient, scalable, and visually
